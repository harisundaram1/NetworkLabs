...
def computeWalkingTime(rest_data, grid, hashgrid):
    ...
    cells = grid.keys()[0:2500]         # 3127 Batch 1 : 2500 (0-2499) - Home, Batch 2: 627 (2500-3126) - VM
    rest_ids = rest_data.keys()         # 192
    rest_groups = hashgrid.keys()[37]    # 97  Pranav your Batch is : index 37-66. Increment this daily and run.
