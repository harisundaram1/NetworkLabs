from script import find_images,is_int,ignore,relevance_score,find_weight,begin
...
def connect():
	...
	client.db_open( "NetworkLabs", "root", "root")
	return client
...
def rest_visited_by_friends(rid,msg_type,restaurant_name=""):
	...
	if (check_data_existence(all_friends_rest_visits)):
		...
		if(msg_type==1):
			...
			cmd_str = 'create vertex Card set type="info",comment_count=0,comment_list=[],like_count=0,like_list=[],people_involved=[],created_at="'+str(int(creation_date.strftime('%s'))*1000)+'",created_at_datetime="'+str(creation_date.strftime('%Y-%m-%d'))+'",text="'+msg+'"'
			print cmd_str
	...
	if (check_data_existence(all_friends_rest_visits_weekly)):
		...
		if (msg_type==1):
			...
			print msg
			msg = ''+str(healthy_friends_weekly)+' out of '+str(total_friends)+' of your friends have eaten healthy over the past week'
			cmd_str = 'create vertex Card set comment_count=0,type="info",comment_list=[],like_count=0,like_list=[],people_involved=[],created_at="'+str(int(creation_date.strftime('%s'))*1000)+'",created_at_datetime="'+str(creation_date.strftime('%Y-%m-%d'))+'",text="'+msg+'"'
			print cmd_str
			insert_card(cmd_str,rid)
			print msg
			if spatial_index_weekly:
				msg = ''+str(dsorted_visits_spatial_weekly[spatial_index_weekly][1])+' out of '+str(total_friends)+' of your friends have eaten in '+str(dsorted_visits_spatial_weekly[spatial_index_weekly][0])+' over the past week'
				print msg
			if index_weekly:
	...
	if (check_data_existence(all_friends_rest_visits_monthly)):
		...
		if msg_type==1:
			...
			msg = ''+str(healthy_friends_monthly)+' out of '+str(total_friends)+' of your friends have eaten healthy over the past month'
			print msg
			if index_monthly:
			...
			if spatial_index_monthly:
				msg = ''+str(dsorted_visits_spatial_monthly[spatial_index_monthly][1])+' out of '+str(total_friends)+' of your friends have eaten in '+str(dsorted_visits_spatial_monthly[spatial_index_monthly][0])+' over the past month'
				print msg
...
def rest_visited_by_network(rid,msg_type,restaurant_name=""):
	...
	if (check_data_existence([rest_visits])):
		...
		if (msg_type==1):
			msg = '<table border="1"><p>Top 3 restaurants visited</p><tr><td>'+get_restaurant_name(dsorted_all_restaurant_visits[0][0])+'</td><td>'+str(dsorted_all_restaurant_visits[0][1])+'</td></tr><tr><td>'+get_restaurant_name(dsorted_all_restaurant_visits[1][0])+'</td><td>'+str(dsorted_all_restaurant_visits[1][1])+'</td></tr><tr><td>'+get_restaurant_name(dsorted_all_restaurant_visits[2][0])+'</td><td>'+str(dsorted_all_restaurant_visits[2][1])+'</td></tr></table>'
			#msg = ''+get_restaurant_name(dsorted_all_restaurant_visits[i][0])+'\tVisits:'+ str(dsorted_all_restaurant_visits[i][1])
			print msg
			cmd_str = 'create vertex Card set type="table",comment_count=0,comment_list=[],like_count=0,like_list=[],people_involved=[],created_at="'+str(int(creation_date.strftime('%s'))*1000)+'",created_at_datetime="'+str(creation_date.strftime('%Y-%m-%d'))+'",text="'+msg+'"'
			print cmd_str
		#	insert_card(cmd_str,rid)

			msg =  ''+' Most people in the network have visited '+get_restaurant_name(dsorted_all_restaurant_visits[0][0])
			print msg
			msg = ''+str(int(percent_visited_alltime))+' % of the people in the network have eaten at '+str(rname_alltime)
			print msg
			...
			print msg
			if spatial_index:
				msg = ''+str(dsorted_visits_spatial[spatial_index][1])+' out of '+str(total_people)+' of the people in the network have eaten in '+str(dsorted_visits_spatial[spatial_index][0])
				print msg
			msg = 'The people in the network have walked a total of '+str(steps_walked)+' steps'
			print msg
			msg = walking_message(steps_walked,"If you and the network walk",total_people)
			print msg
			cmd_str = 'create vertex Card set type="info",comment_count=0,comment_list=[],like_count=0,like_list=[],people_involved=[],created_at="'+str(int(creation_date.strftime('%s'))*1000)+'",created_at_datetime="'+str(creation_date.strftime('%Y-%m-%d'))+'",text="'+msg+'"'
			print cmd_str
		#	insert_card(cmd_str,rid)
			...
			print msg
			msg = ''+str(int(percent_notvisited_alltime))+' % of the people in the network have not eaten at '+str(rname_alltime)
			print msg
			cmd_str = 'create vertex Card set type="info",comment_count=0,comment_list=[],like_count=0,like_list=[],people_involved=[],created_at="'+str(int(creation_date.strftime('%s'))*1000)+'",created_at_datetime="'+str(creation_date.strftime('%Y-%m-%d'))+'",text="'+msg+'"'
			print cmd_str
		#	insert_card(cmd_str,rid)
	...
	if (check_data_existence([rest_visits_weekly])):
		...
		if (msg_type==1):
			...
			print msg
			msg = ''+str(healthy_users_weekly)+' out of '+str(total_people)+' of the people in the network have eaten healthy over the past week'
			print msg
	...
	if (check_data_existence([rest_visits_monthly])):
		...
		if msg_type == 1:	
			...
			print msg
			msg = ''+str(desc_cuisine_monthly[index_monthly][1])+' out of '+str(total_people)+' of the people in the network have eaten healthy '+str(desc_cuisine_monthly[index_monthly][0])+' over the past month'
			print msg
			if spatial_index_monthly:
				msg = ''+str(dsorted_visits_spatial_monthly[spatial_index_monthly][1])+' out of '+str(total_people)+' of the people in the network have eaten in '+str(dsorted_visits_spatial_monthly[spatial_index_monthy][0])+' over the past month'
				print msg
		else:
...
def rest_visited_by_vegetarians(rid,veg,msg_type,restaurant_name):
	...
	if (check_data_existence(all_veg_rest_visits)):
		...
		if veg_desc_spatial:
			spatial_index = random.randrange(0,4)
		if msg_type==1:
			msg = '<table border="1"><p>Top 3 restaurants vegetarians visited</p><tr><td><b>Restaurant Name</b></td><td><b>Visits</b></td></tr><tr><td>'+get_restaurant_name(veg_desc_visits[0][0])+'</td><td>'+str(veg_desc_visits[0][1])+'</td></tr><tr><td>'+get_restaurant_name(veg_desc_visits[1][0])+'</td><td>'+str(veg_desc_visits[1][1])+'</td></tr><tr><td>'+get_restaurant_name(veg_desc_visits[2][0])+'</td><td>'+str(veg_desc_visits[2][1])+'</td></tr></table>'
			print msg
			cmd_str = 'create vertex Card set type="table",comment_count=0,comment_list=[],like_count=0,like_list=[],people_involved=[],created_at="'+str(int(creation_date.strftime('%s'))*1000)+'",created_at_datetime="'+str(creation_date.strftime('%Y-%m-%d'))+'",text="'+msg+'"'
			print cmd_str
			insert_card(cmd_str,rid)			
			...
			print msg
			#tags = ["healthy",str(veg_desc_cuisine_monthly[index][0])]
			#begin(tags,msg)
			if spatial_index:
		...
		if rname_alltime:
			...
			if (msg_type==1):
				...
				if len(major_desc_visits)>=3:
					...
					print majors
					msg = '<table border="1"><p>Top 3 restaurants' +str(majors)+str(year)+'students visited</p><tr><td><b>Restaurant Name</b></td><td><b>Visits</b></td></tr><tr><td>'+get_restaurant_name(major_desc_visits[0][0])+'</td><td>'+str(major_desc_visits[0][1])+'</td></tr><tr><td>'+get_restaurant_name(major_desc_visits[1][0])+'</td><td>'+str(major_desc_visits[1][1])+'</td></tr><tr><td>'+get_restaurant_name(major_desc_visits[2][0])+'</td><td>'+str(major_desc_visits[2][1])+'</td></tr></table>'
			#msg = ''+get_restaurant_name(dsorted_all_restaurant_visits[i][0])+'\tVisits:'+ str(dsorted_all_restaurant_visits[i][1])
					print msg
					cmd_str = 'create vertex Card set type="table",comment_count=0,comment_list=[],like_count=0,like_list=[],people_involved=[],created_at="'+str(int(creation_date.strftime('%s'))*1000)+'",created_at_datetime="'+str(creation_date.strftime('%Y-%m-%d'))+'",text="'+msg+'"'
					print cmd_str
				...
				msg = ''+str(total_major-major_desc_cuisine[index][1])+' out of '+str(total_major)+' of the of '+str(majors)+' '+str(year)+' students have not eaten healthy '+str(major_desc_cuisine[index][0])
				print msg
				cmd_str = 'create vertex Card set type="info",comment_count=0,comment_list=[],like_count=0,like_list=[],people_involved=[],created_at="'+str(int(creation_date.strftime('%s'))*1000)+'",created_at_datetime="'+str(creation_date.strftime('%Y-%m-%d'))+'",text="'+msg+'"'
				print cmd_str
				insert_card(cmd_str,rid)
	...
	if (check_data_existence(all_major_rest_visits_weekly)):
		...
		if rname_weekly:
			...
			if (msg_type==1):
				...
				print msg
				msg = ''+str(healthy_major_weekly)+' out of '+str(total_major)+' of the of '+str(majors)+' '+str(year)+' students have eaten healthy over the past week'
				print msg
				cmd_str = 'create vertex Card set type="info",comment_count=0,comment_list=[],like_count=0,like_list=[],people_involved=[],created_at="'+str(int(creation_date.strftime('%s'))*1000)+'",created_at_datetime="'+str(creation_date.strftime('%Y-%m-%d'))+'",text="'+msg+'"'
				print cmd_str
				insert_card(cmd_str,rid)
	...
	if (check_data_existence(all_major_rest_visits_monthly)):
		...
		if rname_monthly:
			...
			if (msg_type==1):
				...
				print msg
				msg = ''+str(major_desc_cuisine_monthly[index_monthly][1])+' out of '+str(total_major)+' of the of '+str(majors)+' '+str(year)+' students have eaten'+str(w1_m)+ 'healthy '+str(major_desc_cuisine_monthly[index_monthly][0])+str(w2_m)+' over the past month'
				print msg
...
#	print named_friend_name
	...
	if rest_visits:
		...
		if msg_type==1:
			...
			if unhealthy_visits==0:
				...
				msg = ''+str(named_friend_name)+' has eaten healthy food '+str(healthy_visits)+' times'		
		else:
	...
	if rest_visits_weekly:
		...
		if msg_type==1:
			...
			print msg
			if index_weekly:
				msg = ''+str(named_friend_name)+' has eaten healthy '+str(desc_cuisine_weekly[index_weekly][0])+' '+str(desc_cuisine_weekly[index_weekly][1])+' times over the past week'
				print msg
			...
			msg = ''+str(named_friend_name)+' has visited '+str(asc_visitcount_weekly[0][0])+' '+str(asc_visitcount_weekly[0][1])+' times over the past week'
			print msg
			cmd_str = 'create vertex Card set type="info",comment_count=0,comment_list=[],like_count=0,like_list=[],people_involved=[],created_at="'+str(int(creation_date.strftime('%s'))*1000)+'",created_at_datetime="'+str(creation_date.strftime('%Y-%m-%d'))+'",text="'+msg+'"'
			print cmd_str
	...
	if rest_visits_monthly:	
		...
		if msg_type==1:
			...
			print msg
			msg = ''+str(named_friend_name)+' has visited '+get_restaurant_name(desc_visitcount_monthly[0][0])+' most times over the past month'
			print msg
			cmd_str = 'create vertex Card set type="info",comment_count=0,comment_list=[],like_count=0,like_list=[],people_involved=[],created_at="'+str(int(creation_date.strftime('%s'))*1000)+'",created_at_datetime="'+str(creation_date.strftime('%Y-%m-%d'))+'",text="'+msg+'"'
			print cmd_str
			insert_card(cmd_str,user_id)
			...
			if desc_cuisine_monthly:
				...
				ret_val = begin(tags,msg,"namedfriend_overlay_cuisine_monthly.jpg")
				if ret_val == 1:
					recid_img = create_binary_data("/home/chndrsh4/namedfriend_overlay_cuisine_monthly.jpg")
					cmd_str = 'create vertex Card set type="info",comment_count=0,comment_list=[],like_count=0,like_list=[],people_involved=[],created_at="'+str(int(creation_date.strftime('%s'))*1000)+'",created_at_datetime="'+str(creation_date.strftime('%Y-%m-%d'))+'",image="'+recid_img+'"'
...
#	(rid_frequent,rname_frequent) = get_most_visited(userid)
	...
	if recent_visit and most_visited:
		...
		if rname:
			...
			cmd_str = 'create vertex Card set type="feedback",comment_list=[],like_list=[],user_response="",created_at="'+str(int(creation_date.strftime('%s'))*1000)+'",created_at_datetime="'+str(creation_date.strftime('%Y-%m-%d'))+'",text="'+msg+'"'
#			print cmd_str
...
if __name__ == '__main__':
	cl = connect()
	peopleid = cl.command("select @rid from Person")
...
#		graph_title = "Healthiest restaurants in Champaign-Urbana"
#		rname = []
#		healthy_dishes = []
#		healthy_rest = cl.command("select * from Restaurant order by health_option desc")
#		for i in range(5):
#			rname.append(healthy_rest[i].name)
#			healthy_dishes.append(healthy_rest[i].health_option)
#		recid_img = plotbarchart(rname,healthy_dishes,rname,"Restaurants","Healthy Options",graph_title,'r')
#		cmd_str = 'create vertex Card set type="info",comment_list=[],like_list=[],people_involved=[],created_at="'+str(int(creation_date.strftime('%s'))*1000)+'",created_at_datetime="'+str(creation_date.strftime('%Y-%m-%d'))+'",image="'+recid_img+'"'
#		card_rid = insert_card(cmd_str,peopleid[i].rid,1)
#		id_rec = cl.command('create edge has_uploaded_image from '+str(card_rid)+' to '+str(recid_img))
#		print id_rec[0].rid
